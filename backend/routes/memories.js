...
router.get('/', auth, async (req, res) => {
    try {
        ...
        // ⚡ Bolt: Use .select() and .lean() to only fetch required partnerId and avoid Mongoose overhead
        ...
        // ⚡ Bolt: Use .lean() on read-only array query to reduce memory footprint
