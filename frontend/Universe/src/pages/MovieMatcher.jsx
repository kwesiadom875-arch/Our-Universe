...
const MovieMatcher = () => {
    ...
    if (movies.length === 0) return <div className="movie-matcher-container">Loading Movies...</div>;
    ...
    if (!currentMovie) return (
        <div className="movie-matcher-container">
            <div className="matcher-header"><h1>No more movies! 🎬</h1></div>
        </div>
    );
...
>
    ...
    <div className="card-overlay">
        ...
        <div className="movie-meta">
            ...
            <span className="rating-badge">⭐ {currentMovie.vote_average.toFixed(1)}</span>
        </div>
    ...
    <div className="controls">
        <button className="control-btn btn-pass" onClick={() => manualSwipe('left')}>❌</button>
        <button className="control-btn btn-like" onClick={() => manualSwipe('right')}>💚</button>
    </div>
